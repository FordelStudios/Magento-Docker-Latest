<?php
// app/code/Formula/CategoryBanners/Model/BannerImageUploader.php
namespace Formula\CategoryBanners\Model;

use Formula\CategoryBanners\Api\BannerImageUploaderInterface;
...
class BannerImageUploader implements BannerImageUploaderInterface
{
     ...
     * @var string
     */
    private $bannerImagePath = 'formula/categorybanner';
