...
class ReaddWalletBalanceCustomerAttribute implements DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $customerSetup->addAttribute(Customer::ENTITY, 'wallet_balance', [
            ...
            'is_searchable_in_grid' => false,  // This is the key fix - no FULLTEXT search
            'adminhtml_only' => 1,
            'default' => '0.00'
        ]);
    ...
    {
        return [
            RemoveWalletBalanceAttribute::class
        ];
    }
