<?php
namespace Formula\SkinConcern\Ui\DataProvider\SkinConcern;
    ...
    protected function searchResultToOutput(SearchResultInterface $searchResult)
    {
        ...
        foreach ($searchResult->getItems() as $item) {
            ...
            if (!empty($itemData['logo'])) {
                ...
                $itemData['logo_src'] = $mediaUrl . 'skinconcern/logo/' . $itemData['logo'];
                $itemData['logo_alt'] = $itemData['name'] ?? 'SkinConcern Logo';
                $itemData['logo_link'] = $mediaUrl . 'skinconcern/logo/' . $itemData['logo'];
