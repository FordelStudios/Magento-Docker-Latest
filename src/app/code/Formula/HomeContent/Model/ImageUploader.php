...
class ImageUploader
{
    ...
    public function __construct(
        ...
        $this->logger = $logger;
        $this->baseTmpPath = "formula/tmp/homecontent";
        $this->basePath = "formula/homecontent";
    ...
    public function saveFileToTmpDir($fileId)
    {
        try {
            ...
            $this->logger->critical('Upload error: ' . $e->getMessage());
            throw new LocalizedException(
                __('Upload failed. Error: %1', $e->getMessage())
            );
        }
    }
}