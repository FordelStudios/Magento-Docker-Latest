<?php
// app/code/Formula/CountryFormulaBanners/Controller/Adminhtml/CountryFormulaBanner/InlineEdit.php
...
class InlineEdit extends Action
{
     ...
     *
     * @param \Formula\CountryFormulaBanners\Model\CountryFormulaBanner $banner
