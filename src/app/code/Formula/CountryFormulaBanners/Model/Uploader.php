<?php
// app/code/Formula/CountryFormulaBanners/Model/Uploader.php
...
class Uploader
{
    const IMAGE_TMP_PATH = 'formula/tmp/countryformulabanner';
    const IMAGE_PATH = 'formula/countryformulabanner';
