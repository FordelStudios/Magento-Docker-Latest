/**
 * Extends Magento_Backend/js/media-uploader to allow WebP uploads in the product gallery.
 * Only change: 'webp' added to allowedExt array (line with allowedExt declaration).
 */
