<?php
namespace Formula\HairConcern\Ui\DataProvider\HairConcern;
    ...
    protected function searchResultToOutput(SearchResultInterface $searchResult)
    {
        ...
        foreach ($searchResult->getItems() as $item) {
            ...
            if (!empty($itemData['logo'])) {
                ...
                $itemData['logo_src'] = $mediaUrl . 'hairconcern/logo/' . $itemData['logo'];
                $itemData['logo_alt'] = $itemData['name'] ?? 'HairConcern Logo';
                $itemData['logo_link'] = $mediaUrl . 'hairconcern/logo/' . $itemData['logo'];
                $itemData['logo_orig_src'] = $mediaUrl . 'hairconcern/logo/' . $itemData['logo'];
            }
