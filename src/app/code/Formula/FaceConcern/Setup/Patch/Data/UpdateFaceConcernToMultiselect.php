...
class UpdateFaceConcernToMultiselect implements DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $attributeId = $eavSetup->getAttributeId(Product::ENTITY, 'faceconcern');
        if ($attributeId) {
            // If exists, we'll delete it and recreate it as multiselect
            $eavSetup->removeAttribute(Product::ENTITY, 'faceconcern');
        }
        ...
        $eavSetup->addAttribute(
            ...
            [
                ...
                'source' => \Formula\FaceConcern\Model\Product\Attribute\Source\FaceConcern::class,
                'required' => false,
