<?php
namespace Formula\Ingredient\Ui\DataProvider\Ingredient;
    ...
    protected function searchResultToOutput(SearchResultInterface $searchResult)
    {
        ...
        foreach ($searchResult->getItems() as $item) {
            ...
            if (!empty($itemData['logo'])) {
                ...
                $itemData['logo_src'] = $mediaUrl . 'ingredient/logo/' . $itemData['logo'];
                $itemData['logo_alt'] = $itemData['name'] ?? 'Ingredient Logo';
