<?php
namespace Formula\BodyConcern\Ui\DataProvider\BodyConcern;
    ...
    protected function searchResultToOutput(SearchResultInterface $searchResult)
    {
        ...
        foreach ($searchResult->getItems() as $item) {
            ...
            if (!empty($itemData['logo'])) {
                ...
                $itemData['logo_src'] = $mediaUrl . 'bodyconcern/logo/' . $itemData['logo'];
                $itemData['logo_alt'] = $itemData['name'] ?? 'BodyConcern Logo';
                $itemData['logo_link'] = $mediaUrl . 'bodyconcern/logo/' . $itemData['logo'];
                $itemData['logo_orig_src'] = $mediaUrl . 'bodyconcern/logo/' . $itemData['logo'];
            }
